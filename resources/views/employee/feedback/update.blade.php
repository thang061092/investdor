...
@section('page_name', '- Cập nhật ý kiến phải hồi')
@section("content")
    <div class="row mb-3">
        <div class="col-12">
            <ol class="breadcrumb" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href=""
                                                                   class="text-info">{{__('page_name.update_feedback')}}</a>
                </li>
            </ol>
        </div>
    </div>
                                        ...
                                        <div class="col-md-6 col-sm-12 content">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea type="text" class="form-control" name="feedback_vi" id="feedback_vi"
                                                    rows="4" cols="50">{{$detail->feedback_vi}}</textarea>
                                        ...
                                        <div class="col-md-6 col-sm-12 content">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea type="text" class="form-control" name="feedback_en" id="feedback_en"
                                                    rows="4" cols="50" >{{$detail->feedback_en}}</textarea>
