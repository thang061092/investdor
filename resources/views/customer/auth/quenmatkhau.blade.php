...
@section('page_name', ' '. __('auth.forgot_password'))
@section("content")
    <div class="box-full d-flex align-items-center justify-content-between"
        ...
        <div class="container">
            <div class="wrapper center mx-auto">
                <a href="" title="" class="big-logo d-block img text-center"> <img
                        src="{{asset('frontend/images/logo.png')}}"
                        class="img-fluid" alt=""/> </a>
                <div class="frm auth__frm p-xl-4 p-3">
                    <p class="title auth__tit mb-2">{{__('auth.Password_retrieval')}}</p>
                    <div class="desc auth__note"><span
                            class="note d-inline-block text-bdy">{{__('auth.not_have_account')}}</span> <a
                    ...
                    <div class="form-group auth__wrap d-flex align-items-center px-md-3 px-2 mb-lg-4 mb-3">
                        <input type="email" class="form-control auth__inp border-0 p-0" placeholder="Email" name="email"/>
                        <div class="auth__ico">
                    ...
                    <button type="button" class="btn_all submit auth__submit auth_forgot_password btn-block mb-xl-4 mb-sm-3 mb-4">
                        {{__('button.send')}}
                    </button>
                </div>
            </div>
