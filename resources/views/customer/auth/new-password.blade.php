        ...
        <div class="container">
            <div class="wrapper center mx-auto">
                ...
                <div class="frm auth__frm p-xl-4 p-3">
                    <p class="title auth__tit mb-2">{{__('auth.forgot_password')}}</p>
                    ...
                    <div class="form-group auth__wrap d-flex align-items-center px-md-3 px-2">
                        <input type="password"
                               class="form-control auth__inp frm-pwd border-0 p-0"
                    ...
                    <div class="form-group auth__wrap d-flex align-items-center px-md-3 px-2">
                        <input type="password"
                               class="form-control auth__inp frm-pwd border-0 p-0"
                               placeholder="{{__('auth.re_enter_password')}}" name="re_password"
                               value="{{request()->old('re_password')}}"/>
                        <div class="auth__ico show-ico">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <input type="hidden" name="token" value="{{request()->get('e')}}">
                    <button type="button"
                            class="btn_all submit auth__submit new_password_post btn-block mb-xl-4 mb-sm-3 mb-4">
                        {{__('button.confirm')}}
                    </button>
                </div>
            </div>
