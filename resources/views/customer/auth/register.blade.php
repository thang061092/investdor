                ...
                <form action="{{route('customer.register_submit')}}" method="post" class="frm auth__frm p-xl-4 p-3">
                    ...
                    <div class="form-group auth__wrap d-flex align-items-center px-md-3 px-2">
                        <input type="text"
                               ...
                               name="full_name"
                               placeholder="{{__('auth.enter_your_name')}}" value="{{old('full_name')}}"/>
                        <div class="auth__ico">
                    ...
                    <div class="form-group auth__wrap d-flex align-items-center px-md-3 px-2 mb-xl-4 mb-3">
                        <input type="password"
                               class="form-control auth__inp frm-pwd border-0 p-0 @if($errors->has('password_confirmation'))is-invalid @endif"
                               placeholder="{{__('auth.re_enter_password')}}" name="password_confirmation" value="{{old('password_confirmation')}}"/>
                        <div class="auth__ico show-ico">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    @if($errors->has('password_confirmation'))
                        <p class="text-danger"
                           style="padding-bottom: 10px;">{{ $errors->first('password_confirmation') }}</p>
                    @endif
