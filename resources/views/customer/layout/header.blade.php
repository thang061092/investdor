...
<header class="header {{!empty(session()->get('customer')) ? 'is-login':'not-login'}}">
    <div class="container">
        <div class="row align-items-center">
            ...
            @if(!empty(session()->get('customer')))
                <!--DA LOGIN-->
                    <div class="group-user-mobile d-xl-none d-block">
                        <a href="{{route('customer.user.manager')}}" title="{{__('auth.personal_information')}}"
                           class="group-user-mobile-link"> {{__('auth.personal_information')}}</a>
                        <a href="{{route('notification.list')}}" title="{{__('auth.notification')}}"
                           class="group-user-mobile-link">{{__('auth.notification')}}</a>
                    </div>
                    <!--DA LOGIN-->
            ...
            @else
                <!--DA LOGIN-->
                    <a href="{{route('notification.list')}}" title="" class="notification-link mr-3">
