    ...
    <div class="manager-panel">
        <div class="container">
            <div class="row ls-index mb-xl-4 mb-3 wow fadeInUp">
                ...
                <div class="col-lg-auto col-md-6 col-12 mb-lg-0 mb-3">
                    <div class="box-index">
                        <p class="title mb-2">Lợi nhuận</p>
                        <div class="index">XX.000.000$</div>
                    </div>
                </div>
                <div class="col-lg-auto col-md-6 col-12 mb-lg-0 mb-3">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <p class="title_lg pt-2 wow fadeInUp">Danh sách dự án đã hoàn thành</p>
            ...
            <div class="row mx-0 item-project-invest d-lg-flex d-none wow fadeInUp">
                ...
                <div class="col-lg-auto px-0">
                    <p class="c-label">Giá trị khoản đầu tư</p>
                </div>
                <div class="col-lg-auto px-0">
                    <p class="c-label">Lợi nhuận</p>
                </div>
                <div class="col-lg-auto px-0">
                    <p class="c-label">Lợi nhuận</p>
                </div>
                ...
                <div class="col-lg-auto px-0">
                    <p class="c-label">Ngày kết thúc</p>
                </div>
                <div class="col-lg-auto px-0">
            ...
            <div class="row mx-0 item-project-invest wow fadeInUp">
                ...
                <div class="col-lg-auto px-0">
                    <p class="c-value" data-title="Dự án">
                        xx.xxx.xxx$
                    </p>
                </div>
                <div class="col-lg-auto px-0">
                ...
                <div class="col-lg-auto px-0">
                    <p class="c-value" data-title="Giá trị khoản đầu tư">
                        xx.xxx.xxx$
                    </p>
                </div>
                <div class="col-lg-auto px-0">
                    <p class="c-value" data-title="Lợi nhuận">
                        xx%
                    </p>
                </div>
                <div class="col-lg-auto px-0">
                ...
                <div class="col-lg-auto px-0">
                    <p class="c-value" data-title="Ngày kết thúc">
                        12/11/2021
                    </p>
                </div>
                <div class="col-lg-auto px-0">
