    ...
    <div class="manager-panel">
        <div class="container">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <p class="title_lg pt-2 wow fadeInUp">{{__('table.list_of_investments')}}</p>
                <form action="{{route('customer.user.manager')}}" method="post" accept-charset="utf-8" class="frm-filter">
                    @csrf
            ...
            <div class="row flex-lg-nowrap mx-0 item-project-invest d-lg-flex d-none wow fadeInUp"
                ...
                <div class="col-lg-auto px-0">
                    <p class="c-label" style="text-align: center">{{__('table.temporary_profit')}}</p>
                </div>
                <div class="col-lg-auto px-0">
