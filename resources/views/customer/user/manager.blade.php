...
<div class="manager-panel">
    <div class="container">
        ...
        <div class="row mx-0 item-project-invest flex-lg-nowrap wow fadeInUp">
            <div class="col-lg-auto px-0">
            ...
            <div class="col-lg-auto px-0">
                <p class="c-value" data-title="Lợi nhuận tạm tính">xx%</p>
            </div>
            <div class="col-lg-auto px-0">
                <p class="c-value" data-title="Ngày bắt đầu">12/11/2021</p>
            </div>
            <div class="col-lg-auto px-0">
                <p class="c-value" data-title="Thời gian đầu tư">12 tháng</p>
            </div>
        </div>
