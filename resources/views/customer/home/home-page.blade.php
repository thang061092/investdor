            ...
            <div class="row">
                <div class="col-lg-3 aside mb-lg-0 mb-3 wow fadeInLeft">
                    <div class="filter_mobile d-lg-none d-flex align-items-center justify-content-between">
                        <p class="title">{{__('project.chance_for_you', ['total'=> count($projects) > 0 ? $projects->total() : 0])}}</p>
                        <div class="box">
                    ...
                    <div class="box-filter">
                        <p class="title_lg">{{__('project.chance_for_you', ['total'=> count($projects) > 0 ? $projects->total() : 0])}}</p>
