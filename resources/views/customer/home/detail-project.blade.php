    ...
    <section class="tabs-project-detail">
        <div class="container">
            ...
            <div class="navv-tabs p-2">
                @if($config && $config['extend'] == 'active')
