    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-12 order-lg-3 order-1 align-items-center justify-content-lg-end d-xl-flex d-none">
                ...
                <a href="" title="Đăng nhập" class="btn_all blue d-inline-block mr-2" style="display: none !important">Đăng
                    nhập</a>
                <a href="" title="Đăng ký" class="btn_all white d-inline-block" style="display: none !important">Đăng
                    ký</a>
                <!--CHUA LOGIN-->
                <!--DA LOGIN-->
