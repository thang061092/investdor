    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-9 col-12 order-lg-2 order-3 box-menu">
                ...
                <a href="" title="Đăng nhập" class="btn_all blue d-xl-none d-inline-block mr-2 login" style="display: none !important">Đăng nhập</a>
                <a href="" title="Đăng ký" class="btn_all white d-xl-none d-inline-block register" style="display: none !important">Đăng ký</a>
                <!--CHƯA LOGIN-->
            </div>
            ...
            <div class="col-lg-4 col-12 order-lg-3 order-1 align-items-center justify-content-lg-end d-xl-flex d-none">
                ...
                <a href="" title="Đăng nhập" class="btn_all blue d-inline-block mr-2" style="display: none !important">Đăng nhập</a>
                <a href="" title="Đăng ký" class="btn_all white d-inline-block" style="display: none !important">Đăng ký</a>
                <!--CHUA LOGIN-->
                <!--DA LOGIN-->
                ...
                <div class="group-box group-user">
                    <a href="" title="Thông tin cá nhân" class="btn_user unconfirmed mr-3">
                        <img src="images/thong-tin-ca-nhan.jpg" class="img-fluid" alt="" />
                    </a>
