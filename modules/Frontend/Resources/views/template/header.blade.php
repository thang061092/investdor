    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-9 col-12 order-lg-2 order-3 box-menu">
                ...
                <a href="" title="Đăng nhập" class="btn_all blue d-xl-none d-inline-block mr-2 login"
                   style="display: none !important">Đăng nhập</a>
                <a href="" title="Đăng ký" class="btn_all white d-xl-none d-inline-block register"
                   style="display: none !important">Đăng ký</a>
                <!--CHƯA LOGIN-->
            </div>
