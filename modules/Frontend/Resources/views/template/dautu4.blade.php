        ...
        <div class="row">
            <div class="col-lg-auto mb-lg-0 mb-3 wow fadeInLeft">
                <div class="group-box">
                    ...
                    <input disabled type="text" name="" placeholder="VPBank" class="form-control mb-lg-4 mb-3 pb-1" />
                    <label for="" class="d-block mb-2 c-label">
                        Tên tài khoản nhận
                    </label>
                    ...
                    <div class="box-copy mb-lg-3 mb-2 pb-1">
                        <input disabled type="text" name="" value="003625698" placeholder="003625698" class="form-control" />
                    ...
                    <div class="box-copy mb-lg-3 mb-2 pb-1">
                        <input type="text" name="" value="noidungck0001639875" placeholder="noidungck0001639875" class="form-control" />
                        <span class="copy" data-title-success="Copy thành công" data-title-fail="Copy thất bại !">Sao chép</span>
                    </div>
