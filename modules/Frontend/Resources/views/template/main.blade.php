...
<section class="section-package-invest">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 max-w mb-lg-0 mb-4 mt-lg-0 mt-4 d-lg-flex flex-column justify-content-between wow fadeInLeft">
                <div class="box">
...
<section class="numbers section_all" style="
    ...
    <div class="container max-w">
        <div class="row justify-content-center">
            <div class="col-lg-auto col-md-6 col-sm-6 mb-lg-0 mb-3 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">
                <div class="number">10.200</div>
                <div class="text">Khách hàng</div>
            </div>
            <div class="col-lg-auto col-md-6 col-sm-6 mb-lg-0 mb-3 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.6s">
                <div class="number">100.200.000$</div>
                <div class="text">Đầu tư</div>
            </div>
            <div class="col-lg-auto col-md-6 col-sm-6 mb-lg-0 mb-3 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.7s">
                <div class="number">100.200.000$</div>
                <div class="text">Lợi nhuận</div>
            </div>
            <div class="col-lg-auto col-md-6 col-sm-6 mb-lg-0 mb-3 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.8s">
    ...
    <div class="container-fluid">
        <div class="swiper-prev swiper_btn">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M3.3335 10.0003C3.3335 9.54009 3.70659 9.16699 4.16683 9.16699H15.8335C16.2937 9.16699 16.6668 9.54009 16.6668 10.0003C16.6668 10.4606 16.2937 10.8337 15.8335 10.8337H4.16683C3.70659 10.8337 3.3335 10.4606 3.3335 10.0003Z" fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5894 3.57709C10.9149 3.90252 10.9149 4.43016 10.5894 4.7556L5.34534 9.99967L10.5894 15.2438C10.9149 15.5692 10.9149 16.0968 10.5894 16.4223C10.264 16.7477 9.73634 16.7477 9.41091 16.4223L3.57757 10.5889C3.25214 10.2635 3.25214 9.73586 3.57757 9.41042L9.41091 3.57709C9.73634 3.25165 10.264 3.25165 10.5894 3.57709Z" fill="white" />
            </svg>
        </div>
        <div class="swiper-next swiper_btn">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M3.3335 10.0003C3.3335 9.54009 3.70659 9.16699 4.16683 9.16699H15.8335C16.2937 9.16699 16.6668 9.54009 16.6668 10.0003C16.6668 10.4606 16.2937 10.8337 15.8335 10.8337H4.16683C3.70659 10.8337 3.3335 10.4606 3.3335 10.0003Z" fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.41058 3.57709C9.73602 3.25165 10.2637 3.25165 10.5891 3.57709L16.4224 9.41042C16.7479 9.73586 16.7479 10.2635 16.4224 10.5889L10.5891 16.4223C10.2637 16.7477 9.73602 16.7477 9.41058 16.4223C9.08514 16.0968 9.08514 15.5692 9.41058 15.2438L14.6547 9.99967L9.41058 4.7556C9.08514 4.43016 9.08514 3.90252 9.41058 3.57709Z" fill="white" />
            </svg>
        </div>
                    ...
                    <div class="item_project">
                        ...
                        <div class="p-3 pb-lg-4">
                            ...
                            <div class="project_desc mb-lg-3 mb-2">
                                Mô tả dự án - Lorem Ipsum is simply dummy Lorem
