            ...
            <div class="row">
                <div class="col-lg-4 mb-lg-0 mb-2 wow fadeInUp">
                    ...
                    <label for="upload-avatar" class="upload-avatar">
                        <input type="file" name="avatar" id="upload-avatar" class="d-none" accept="image/*" onchange="document.getElementById('avatar').src = window.URL.createObjectURL(this.files[0])" />
                ...
                <div class="col-lg-4 col-md-6 mb-lg-0 mb-0 wow fadeInUp">
                    ...
                    <input disabled type="text" name="" placeholder="nguyenvtp2342@gmail.com" class="form-control mb-3" />
                ...
                <div class="col-lg-4 col-md-6 mb-lg-0 mb-2 wow fadeInUp">
                    ...
                    <select name="" class="e-select nice-select mb-3" id="banks" data-text="Chọn ngân hàng" data-default="Chọn">
                    ...
                    <select name="" class="e-select nice-select mb-3" id="city" data-text="Chọn thành phố" data-default="Chọn">
                    ...
                    <select name="" class="e-select nice-select mb-3" id="province" data-text="Chọn quận/ huyện" data-default="Chọn">
                        <option selected value="">
                            Chọn quận/ huyện
                        </option>
                    </select>
                    ...
                    <select name="" class="e-select nice-select mb-3" id="ward" data-text="Chọn xã/ phường/ thị trấn" data-default="Chọn">
                        <option selected value="">
