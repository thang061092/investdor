                    ...
                    <div class="infomation-project-invest">
                        ...
                        <a href="" title="" class="btn_all lg wow fadeInUp">Đầu tư ngay
                            <svg class="ml-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M3.33398 9.99935C3.33398 9.53911 3.70708 9.16602 4.16732 9.16602H15.834C16.2942 9.16602 16.6673 9.53911 16.6673 9.99935C16.6673 10.4596 16.2942 10.8327 15.834 10.8327H4.16732C3.70708 10.8327 3.33398 10.4596 3.33398 9.99935Z" fill="white" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.41009 3.57806C9.73553 3.25263 10.2632 3.25263 10.5886 3.57806L16.4219 9.4114C16.7474 9.73683 16.7474 10.2645 16.4219 10.5899L10.5886 16.4232C10.2632 16.7487 9.73553 16.7487 9.41009 16.4232C9.08466 16.0978 9.08466 15.5702 9.41009 15.2447L14.6542 10.0007L9.41009 4.75657C9.08466 4.43114 9.08466 3.9035 9.41009 3.57806Z" fill="white" />
                            </svg>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-lg-0 mb-4">
                <div class="item-main">
                    <div class="title d-flex align-items-center justify-content-between mb-lg-4 mb-3">
                        ...
                        <div class="c-img">
                            <img src="images/dc.png" class="img-fluid" alt="" />
                        </div>
                    </div>
                    <div class="contents">
                        ( giới thiệu về đự án)Lorem Ipsum is simply
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-lg-0 mb-4">
                <div class="item-main">
                    <div class="title d-flex align-items-center justify-content-between mb-lg-4 mb-3">
                        ...
                        <div class="c-img">
                            <img src="images/qua-cau.png" class="img-fluid" alt="" />
                        </div>
                    </div>
                    <div class="contents">
                        ( giới thiệu về đự án)Lorem Ipsum is simply
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-lg-0 mb-4">
                <div class="item-main">
                    <div class="title d-flex align-items-center justify-content-between mb-lg-4 mb-3">
                        ...
                        <div class="c-img">
                            <img src="images/ngoi-nha.png" class="img-fluid" alt="" />
                        </div>
                    </div>
                    <div class="contents">
                        ( giới thiệu về đự án)Lorem Ipsum is simply
        ...
        <div class="toggle-content mb-xl-3 mb-4 pb-1">
            <p class="btn_toggle d-flex align-items-center">
                <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.99935 3.33301C10.4596 3.33301 10.8327 3.7061 10.8327 4.16634V15.833C10.8327 16.2932 10.4596 16.6663 9.99935 16.6663C9.53911 16.6663 9.16602 16.2932 9.16602 15.833V4.16634C9.16602 3.7061 9.53911 3.33301 9.99935 3.33301Z" fill="#03204C" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3.33398 10.0003C3.33398 9.54009 3.70708 9.16699 4.16732 9.16699H15.834C16.2942 9.16699 16.6673 9.54009 16.6673 10.0003C16.6673 10.4606 16.2942 10.8337 15.834 10.8337H4.16732C3.70708 10.8337 3.33398 10.4606 3.33398 10.0003Z" fill="#03204C" />
                </svg>
                Vị trí dự án
            </p>
            <div class="content mt-3 box-map" style="display: none">
                <div class="maps mb-lg-3 mb-2">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.0977421299594!2d105.8523647!3d21.02877475!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab953357c995%3A0x1babf6bb4f9a20e!2zSOG7kyBIb8OgbiBLaeG6v20!5e0!3m2!1svi!2s!4v1665917227891!5m2!1svi!2s" width="600" height="450" style="border: 0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <p class="title_small mb-lg-3 mb-2 pb-1">
            ...
            <div class="content mt-3" style="display: none">
                <div class="row">
                    <div class="col-lg-3 col-6 mb-4">
                        <div class="img">
                            <img src="images/box.jpg" class="img-fluid" alt="" />
                        </div>
                    </div>
                    <div class="col-lg-3 col-6 mb-4">
                        <div class="img">
                ...
                <div class="swiper swiper-teams">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="human">
                                <div class="img">
                                    <img src="images/hoidong.jpg" class="img-fluid" alt="" />
                                </div>
                                <div class="box">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="item-ratting d-flex flex-wrap">
                        <div class="img">
                            <img src="images/danh-gia.jpg" class="img-fluid" alt="" />
                        </div>
                        <div class="content">
...
<a href="" title="" class="btn_all lg d-lg-none d-block invest-now">Đầu tư ngay
    <svg class="ml-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M3.33398 9.99935C3.33398 9.53911 3.70708 9.16602 4.16732 9.16602H15.834C16.2942 9.16602 16.6673 9.53911 16.6673 9.99935C16.6673 10.4596 16.2942 10.8327 15.834 10.8327H4.16732C3.70708 10.8327 3.33398 10.4596 3.33398 9.99935Z" fill="white"></path>
        <path fill-rule="evenodd" clip-rule="evenodd" d="M9.41009 3.57806C9.73553 3.25263 10.2632 3.25263 10.5886 3.57806L16.4219 9.4114C16.7474 9.73683 16.7474 10.2645 16.4219 10.5899L10.5886 16.4232C10.2632 16.7487 9.73553 16.7487 9.41009 16.4232C9.08466 16.0978 9.08466 15.5702 9.41009 15.2447L14.6542 10.0007L9.41009 4.75657C9.08466 4.43114 9.08466 3.9035 9.41009 3.57806Z" fill="white"></path>
    </svg>
</a>
@stop