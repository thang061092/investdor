@extends("frontend::admin_employee.layout.index")
@section("content")
    <div class="columns d-flex flex-wrap">
        <div class="top-column d-flex flex-wrap align-items-center w-100">
            <p class="table-name">
                ...
                <?= __('Frontend::message.title_page') ?>
            </p>
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    <div class="card-header">
                        <p class="title mb-3">Thông tin cơ bản dự án</p>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $('#create_project').click(function () {
            ...
            $.ajax({
                url: origin + '/frontend_project/create_project',
                method: "POST",
                data: {
